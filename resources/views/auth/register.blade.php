                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email"
                                    ...
                                    @change="checkForEmailAvailability()" value="{{ old('email') }}" required
                                    autocomplete="email">
                            ...
                            <div class="form-group" v-if="is_store_open">
                                ...
                                <input type="text" name="store_name" v-model="store_name" id="store_name"
                                    class="form-control @error('password_confirmation') is-invalid @enderror" autocomplete
                                    autofocus required />
                                @error('store_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                            ...
                            <a href="{{ route('login') }}" class="btn btn-signup btn-block w-75 mt-3">
                                Back to Sign In
                            </a>
                        </form>
                    </div>
